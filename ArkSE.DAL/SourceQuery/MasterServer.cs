...
namespace ArkSE.DAL.SourceQuery
{
    public class MasterServer
    {
        private readonly IPEndPoint _endpoint;
        private static IPEndPoint _anyIpEndPoint = new IPEndPoint(IPAddress.Any, 0);
        ...
        public IEnumerable<IPEndPoint> GetServers(Region region, string filter = null)
        {
            using (var client = new UdpClient())
            {
                ...
                do
                {
                    ...
                    var serverData = client.Receive(ref _anyIpEndPoint);
